...
import shutil, json, re, subprocess, zipfile
...
def process_rounds():
    ...
    js = (f"// VGC Rounds — {len(all_records)} days · "
          ...
          f"const RAW = {json.dumps(all_records)};\n")
...
def process_pace():
    ...
    out.write_text(f"const PACE_DATA = {json.dumps(member_data)};\n", encoding="utf-8")
...
def main():
    ...
    print("\n" + "="*50)
    print("  ✅  Done! Push to GitHub to go live.")
    print("="*50 + "\n")
